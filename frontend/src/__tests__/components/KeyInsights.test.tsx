...
describe('KeyInsights', () => {
    it('renders insight content when an insight is provided', () => {
        render(<KeyInsights insight={mockInsight} />);
        expect(screen.getByText((_, el) => el?.tagName === 'PRE' && el.textContent === mockInsight.content)).toBeInTheDocument();
    });

    it('renders empty state when no insight is provided', () => {
        render(<KeyInsights />);
    ...
    it('does not show regenerate button when canRegenerate is false', () => {
        render(<KeyInsights insight={mockInsight} canRegenerate={false} />);
    ...
    it('shows regenerate button when canRegenerate is true', () => {
        render(<KeyInsights insight={mockInsight} canRegenerate={true} onRegenerate={vi.fn()} />);
    ...
    it('calls onRegenerate when the regenerate button is clicked', async () => {
        ...
        render(<KeyInsights insight={mockInsight} canRegenerate={true} onRegenerate={onRegenerate} />);
